...
class FstLayRandLeNet(nn.Module):
    ...
    def __init__(self, set_name,
        ...
        super(FstLayRandLeNet,self).__init__()
    ...
    def random_operation(self, input_tensor):
        ...
        A_size = int(input_tensor.size()[2])
        ...
        return torch.bmm(torch.bmm(R, # U
                                   ...
                                   Rt).view(num_batches, 1, A_size, A_size) # Ut then resize output
