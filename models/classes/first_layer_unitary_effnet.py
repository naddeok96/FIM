...
class FstLayUniEffNet(nn.Module):
    ...
    def __init__(self, set_name,
        ...
        if pretrained:
            self.net = EfficientNet.from_pretrained(model_name = self.model_name,
                                                    num_classes = self.num_classes,
                                                    image_size  = self.image_size)
        else:
            self.net = EfficientNet.from_name(model_name = self.model_name,
                                                num_classes = self.num_classes,
                                                image_size  = self.image_size)
